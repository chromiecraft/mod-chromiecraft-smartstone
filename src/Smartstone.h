...
enum Misc
{
    ...
    ACTION_RANGE_UTIL_BUTTONS       = 900000,
...
enum StoneActions
{
    ...
    SMARTSTONE_ACTION_LAST_PAGE              = ACTION_RANGE_UTIL_BUTTONS + 1,
    SMARTSTONE_ACTION_NEXT_PAGE              = ACTION_RANGE_UTIL_BUTTONS + 2,
    SMARTSTONE_ACTION_BACK                   = ACTION_RANGE_UTIL_BUTTONS + 3,
